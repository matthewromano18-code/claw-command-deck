...
import {
  Zap, ChevronDown, TrendingUp, BarChart3, CircleDot,
  RefreshCw, Download, Copy, ExternalLink,
  ArrowDownRight, ArrowUpRight, Database, DollarSign,
  Activity, Shield, Clock, AlertTriangle,
    ...
    <Card className="glass-panel overflow-hidden">
      <CardContent className="p-0">
        ...
        <button
          ...
          className="w-full p-4 flex items-start gap-4 hover:bg-accent/30 transition-colors cursor-pointer text-left"
        >
        ...
        <AnimatePresence>
          {expanded && (
            ...
            >
              <div className="space-y-3 p-4 pt-0 border-t border-border/40">
                {/* Stats Grid */}
                <div className="grid grid-cols-4 lg:grid-cols-8 gap-2 pt-3">
